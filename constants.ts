...
export const PRINT_SIZES: PrintSize[] = [
  ...
  { id: '17.4x11.4', name: '17.4cm × 11.4cm（横長・インチ額）', width: 17.4, height: 11.4, aspectRatio: 'aspect-[174/114]' },
  { id: '12.4x16.4', name: '12.4cm × 16.4cm（縦長・インチ額）', width: 12.4, height: 16.4, aspectRatio: 'aspect-[124/164]' },
  { id: '28.2x20.2', name: '28.2cm × 20.2cm（横長・太子額）', width: 28.2, height: 20.2, aspectRatio: 'aspect-[282/202]' },
];
