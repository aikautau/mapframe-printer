...
export const PRINT_SIZES: PrintSize[] = [
  ...
  { id: '12.4x16.4', name: '12.4cm × 16.4cm（インチ額）', width: 12.4, height: 16.4, aspectRatio: 'aspect-[124/164]' },
  { id: '27.2x20.2', name: '27.2cm × 20.2cm（太子額）', width: 27.2, height: 20.2, aspectRatio: 'aspect-[272/202]' },
];
