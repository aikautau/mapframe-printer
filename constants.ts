...
export const PRINT_SIZES: PrintSize[] = [
  ...
  { id: '17.4x12.4', name: '17cm × 12cm（横・インチ額）', width: 17.4, height: 12.4, aspectRatio: 'aspect-[174/124]' },
  { id: '12.4x17.4', name: '12cm × 17cm（縦・インチ額）', width: 12.4, height: 17.4, aspectRatio: 'aspect-[124/174]' },
  { id: '29x20', name: '29cm × 20cm（太子額）', width: 29, height: 20, aspectRatio: 'aspect-[290/200]' },
];
