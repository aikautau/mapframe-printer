...
export const PRINT_SIZES: PrintSize[] = [
  ...
  { id: '16.4x12.4', name: '16.4cm × 12.4cm（横・インチ額）', width: 16.4, height: 12.4, aspectRatio: 'aspect-[164/124]' },
  { id: '12.4x16.4', name: '12cm × 16cm（インチ額）', width: 12.4, height: 16.4, aspectRatio: 'aspect-[124/164]' },
  { id: '27.4x20.4', name: '27cm × 20cm（太子額）', width: 27.4, height: 20.4, aspectRatio: 'aspect-[274/204]' },
];
